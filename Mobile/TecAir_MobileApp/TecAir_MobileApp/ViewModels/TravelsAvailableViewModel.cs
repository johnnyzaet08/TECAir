...
namespace TecAir_MobileApp.ViewModels
{
    ...
    [DataContract]
    public class TravelsAvailableViewModel : BaseViewModel
    {
        #region Fields
        ...
        /// <summary>
        /// Initializes a new instance for the <see cref="TravelsAvailableViewModel" /> class.
        /// </summary>
        public TravelsAvailableViewModel()
        {
